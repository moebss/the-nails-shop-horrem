      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12 bg-[#fcfaf7] border border-[#e5d9c7] p-8 rounded-3xl shadow-xs">
          ...
          <div className="flex items-center gap-4 text-center md:text-left">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-amber-500 via-[#d97736] to-pink-500 p-0.5 shadow-md shrink-0">
              <div className="w-full h-full bg-stone-900 rounded-[14px] flex items-center justify-center text-white">
                <Instagram className="w-7 h-7 text-amber-300" />
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-stone-600 mt-1 font-normal">
                Tägliche Nail-Art Inspirationen, Trends & Einblicke direkt aus unserem Studio in Horrem.
              </p>
            </div>
          </div>
